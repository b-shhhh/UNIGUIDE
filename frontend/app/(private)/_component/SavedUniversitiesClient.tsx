    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-[#1a2b44]/10 bg-white p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.12em] text-[#4f6682]">My List</p>
            <h2 className="mt-1 text-2xl font-bold text-[#1a2b44]">Saved Universities</h2>
          </div>
          <Link href="/homepage" className="rounded-lg bg-[#1a2b44] px-3 py-2 text-xs font-bold uppercase tracking-[0.08em] text-white">
            Back to Dashboard
          </Link>
        </div>
      </section>
      ...
      {!savedUniversities.length ? (
        <section className="rounded-2xl border border-[#1a2b44]/10 bg-white p-8 text-center">
          <p className="text-sm text-[#4f6682]">No saved universities yet. Save universities from the dashboard cards.</p>
          <Link href="/homepage" className="mt-4 inline-block text-xs font-bold uppercase tracking-[0.08em] text-[#0f766e]">
            Go to dashboard
          </Link>
        </section>
      ) : (
