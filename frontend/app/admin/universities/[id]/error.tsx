...
export default function Error({ reset }: { reset: () => void }) {
  return (
    <div className="space-y-3 rounded-xl border border-[#ffd2d2] bg-white p-5">
      <h2 className="text-lg font-bold text-[#b91c1c]">University page error</h2>
      <p className="text-sm text-[#5f7590]">Something went wrong while loading this university page.</p>
      <button
        type="button"
        onClick={reset}
